...
public class InputManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        undo?.onClick.AddListener(() => characterCleanMove?.commandHandler.UndoCommand());
        redo?.onClick.AddListener(() => characterCleanMove?.commandHandler.RedoCommand());
    }
    ...
    private void SendMoveCommand(Transform objectToMove, Vector3 direction, float distance)
    {
        ...
        characterCleanMove?.commandHandler.AddCommand(movement);
